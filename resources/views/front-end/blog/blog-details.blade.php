...
@section('content')
    ...
    <div class="site-cover  same-height  overlay single-page" style="background-image: url('images/hero_5.jpg');">
        <div class="container">
                    ...
                    <div class="post-content-body">
                        ...
                        <div class="row my-4">
                            <div class="col-md-12 mb-4">
                                <img src="{{asset('front-end-assets')}}/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('front-end-assets')}}/images/img_2_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('front-end-assets')}}/images/img_3_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                        </div>
